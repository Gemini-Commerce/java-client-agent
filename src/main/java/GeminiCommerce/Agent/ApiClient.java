...
import GeminiCommerce.Agent.auth.Authentication;
import GeminiCommerce.Agent.auth.HttpBasicAuth;
import GeminiCommerce.Agent.auth.HttpBearerAuth;
import GeminiCommerce.Agent.auth.ApiKeyAuth;
...
public class ApiClient {
     ...
     * @return a {@link GeminiCommerce.Agent.ApiClient} object
     */
    ...
    */
     ...
     * @throws GeminiCommerce.Agent.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws GeminiCommerce.Agent.ApiException If fail to serialize the given object
     */
     ...
     * @throws GeminiCommerce.Agent.ApiException If fail to read file content from response and write to disk
     ...
     * @throws GeminiCommerce.Agent.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws GeminiCommerce.Agent.ApiException If the response has an unsuccessful status code or
     ...
     * @throws GeminiCommerce.Agent.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws GeminiCommerce.Agent.ApiException If fails to update the parameters
     */
     ...
     * @throws GeminiCommerce.Agent.ApiException If fail to serialize the request body object into a string
     */
